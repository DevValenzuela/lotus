...
export default class NotifService {
  ...
  localNotif(paramsNotify) {
    let date_origin = moment(new Date()).add(1, 'month').format('YYYY-MM-DD');
    this.lastId++;
    PushNotification.localNotification({
      ...
      subtitle: paramsNotify.title, // (optional) smaller title below notification title

      /* iOS and Android properties */
      id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: paramsNotify.title, // (optional)
      message: `${paramsNotify.msg} ${date_origin}`, // (required)
  ...
  scheduleNotif(paramsNotify) {
    ...
    PushNotification.localNotificationSchedule({
      ...
      groupSummary: false, // (optional) set this notification to be the group summary for a group of notifications, default: false
      ongoing: false, // (optional) set whether this is an "ongoing" notification
      actions: ['Si', 'No'], // (Android only) See the doc for notification actions to know more
